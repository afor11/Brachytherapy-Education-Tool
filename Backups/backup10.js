...
function tick(){
    ...
    if (module === "brachytherapy applicators"){
        ...
        ctx.font = getFontSize(canvas.width / 3,canvas.height * 0.05,airKermaText) + "px monospace";
        ctx.fillStyle = "black";
        ctx.beginPath();
        ctx.fillText(airKermaText,ctx.measureText(treatmentTime).width + canvas.width * 0.05,canvas.height * 0.15);

        moduleData.graphAirKermaSlider.x = ctx.measureText(treatmentTime).width + ctx.measureText(airKermaText).width + canvas.width * 0.07;
        moduleData.graphAirKermaSlider.y = canvas.height * 0.135;
    ...
    if ((typeof moduleData.selectedSeed != "undefined") && (moduleData.selectedSeed != -1) && (module === "brachytherapy applicators")){
        ...
        ctx.font = getFontSize(canvas.width * 0.15,canvas.height * 0.05,dwellTimeText) + "px monospace";
        ctx.fillStyle = "black"
        ctx.fillText(dwellTimeText,editMenuPos.x + canvas.width * 0.02,editMenuPos.y + canvas.height * 0.04);
    }
