    ...
    if (module === "string of seeds"){
        ...
        if (moduleData.selectedSeed != -1){
            ...
            if (moduleData.graph1.seeds[moduleData.selectedSeed].model.HDRsource){
                ...
                moduleData.sourceToggle.label = ("Source " + ((moduleData.graph1.seeds[moduleData.selectedSeed].enabled) ? "Enabled" : "Disabled"));
...
function initModule(mod,previousMod){
    ...
    if (mod === "string of seeds"){
        ...
        moduleData = {
            ...
            sourceToggle: new Button({x: 0, y: 0, width: 0, height: 0, label: {text: "Source",font: "default", color: "black"}, bgColor: "white",
                onClick: () => {
                    moduleData.graph1.seeds[moduleData.selectedSeed].enabled = !moduleData.graph1.seeds[moduleData.selectedSeed].enabled;
                    if (moduleData.graph1.seeds[moduleData.selectedSeed].enabled){
        ...
        moduleData.refPointLabel = new NumberInput({
            ...
            onEnter: function (value){
                setDoseAtPoint(moduleData.graph1,moduleData.graph1refPoint,value,moduleData.dwellTimeSlider,moduleData.airKermaSlider);
            },
            numDecimalsEditing: 3
        });
    }
    ...
    if ((mod === "string of seeds") || (mod === "planar array of seeds")){
        //add labels to air kerma and dwell time
...
function checkSeedClicked(graph,boundingBox,graphName){
    ...
    if (typeof seed != "undefined") {
        ...
        if (module === "planar array of seeds"){
            ...
            //adjustFormatting(); // formatting must be adjusted sothat the air kerma and dwell time labels appear in the right place
        }
        if (module === "brachytherapy applicators"){
