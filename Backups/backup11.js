...
function tick(){
    ...
    if (module === "single seed"){
        ...
        ctx.font = getFontSize(moduleData.graph1ModelDropdown.button.width * 0.8,moduleData.graph1ModelDropdown.button.height,AirKermaLabel,(size) => `${size}px monospace`) + "px monospace";
        ctx.fillText(
            AirKermaLabel,
        ...
        ctx.font = getFontSize(moduleData.graph2ModelDropdown.button.width * 0.8,moduleData.graph2ModelDropdown.button.height,AirKermaLabel,(size) => `${size}px monospace`) + "px monospace";
        ctx.fillText(
            AirKermaLabel,
        ...
        if (moduleData.graph1.seeds[0].model.HDRsource){
            ...
            ctx.font = getFontSize(moduleData.graph1ModelDropdown.button.width * 0.8,moduleData.graph1ModelDropdown.button.height,text,(size) => `${size}px monospace`) + "px monospace";
            ctx.fillText(
                text,
    ...
    if (module === "string of seeds"){
        ...
        if (moduleData.selectedSeed != -1){
            ...
            ctx.font = getFontSize(moduleData.addSeed.width,moduleData.addSeed.height,text,(size) => `${size}px monospace`) + "px monospace";
            ctx.fillText(
                text,
            ...
            if (moduleData.graph1.seeds[moduleData.selectedSeed].model.HDRsource){
                ...
                ctx.font = getFontSize(moduleData.deleteSeed.width,moduleData.deleteSeed.height,text,(size) => `${size}px monospace`) + "px monospace";
                ctx.fillText(
                    text,
        ...
        ctx.font = getFontSize(moduleData.addSeed.width * 0.9,moduleData.addSeed.height,text,(size) => `${size}px monospace`) + "px monospace";
        ctx.fillText(
            text,
            moduleData.addSeed.x + moduleData.addSeed.width * 0.05,
