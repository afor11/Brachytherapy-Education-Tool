...
export let tandemAndOvoidsPage = new Module({
    ...
    dropDowns: {
        ...
        applicatorModel: blankDropdown("Applicator: " + prettifyName("tandem+ovoids")),
    ...
    specialVars: {
        ...
        *refreshApplicator(){
            ...
            module.dropDowns.applicatorModel.button.label = "Applicator: " + prettifyName("tandem+ovoids");
            yield* addDropdownOptions(
